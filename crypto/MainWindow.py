...
class Ui_MainEncryForm(object):
    ...
    def retranslateUi(self, MainEncryForm):
        ...
        self.label_2.setText(_translate("MainEncryForm", "仿射加密参数a,b"))
        ...
        self.label_8.setText(_translate("MainEncryForm", "仿射解密参数a,b"))
        self.affineArgA_Tab2.setPlaceholderText(_translate("MainEncryForm", "注意a,b互质"))
        ...
        self.serverPubKeyPush.setText(_translate("MainEncryForm", "生成服务端DH私钥"))
